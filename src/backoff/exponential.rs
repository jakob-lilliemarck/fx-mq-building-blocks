...
impl ExponentialBackoff {
    pub fn new(base: u32, base_delay: Duration) -> Self {
        Self { base, base_delay }
    }

    pub fn try_at(&self, attempted: i32, attempted_at: DateTime<Utc>) -> DateTime<Utc> {
        if attempted <= 0 {
...
mod tests {
    ...
    fn it_computes_exponential_backoff_with_base_2() {
        let attempted_at = DateTime::parse_from_rfc3339("2025-01-01T12:00:00-00:00")
        ...
        let expected_1 = DateTime::parse_from_rfc3339("2025-01-01T12:01:00-00:00")
            .expect("Expected to parse the timestsamp")
            .to_utc();
        let expected_2 = DateTime::parse_from_rfc3339("2025-01-01T12:02:00-00:00")
            .expect("Expected to parse the timestsamp")
            .to_utc();
        let expected_3 = DateTime::parse_from_rfc3339("2025-01-01T12:04:00-00:00")
            .expect("Expected to parse the timestsamp")
            .to_utc();
        let expected_4 = DateTime::parse_from_rfc3339("2025-01-01T12:08:00-00:00")
            .expect("Expected to parse the timestsamp")
            .to_utc();
